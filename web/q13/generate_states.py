...
for state in states_info:
    ...
    for proj_name, proj_desc in state["projects"]:
        ...
        projects_html += f'    <img src="C:\\Users\\laksh\\Desktop\\CLG work\\web\\{img_name}" width="300">\n'
    ...
    for attr_name, attr_desc in state["tourist_attractions"]:
        ...
        tourist_html += f'    <img src="C:\\Users\\laksh\\Desktop\\CLG work\\web\\{img_name}" width="300">\n'
